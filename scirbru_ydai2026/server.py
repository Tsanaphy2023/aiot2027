...
def init_db():
    ...
    default_content = {
        ...
        "announcement": "📢 เปิดรับสมัครครูและนักเรียนที่สนใจเข้าร่วมโครงการอบรมเชิงปฏิบัติการ (เร็วๆ นี้ โปรดติดตาม) ณ คณะวิทยาศาสตร์และเทคโนโลยี มรภ.รำไพพรรณี รับจำนวนจำกัด 60 ที่นั่ง ฟรีไม่มีค่าใช้จ่าย!",
        "workshop_dates": "เร็วๆ นี้ โปรดติดตาม",
